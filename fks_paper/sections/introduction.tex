...
also consistently finds solutions of higher quality.
On the 110 Test Bed~A instances with known proven optima, FKS finds the
optimal solution on 109 --- matching the solution quality of the
state-of-the-art Benders decomposition of \citet{fischetti2016benders}, which
requires up to 50{,}000 seconds per instance to certify those same solutions,
while FKS operates within a 300-second per-subproblem budget.
On Test Bed~B and Test Bed~C p2000-2000 instances, where no proven optima are
available, FKS improves on every published upper bound it encounters,
establishing 22 new best-known solutions.
