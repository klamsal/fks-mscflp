...
Avella et al.\ test bed. FKS finds the proven optimal solution on 109 of the
110 Test Bed~A instances for which an optimum is known, demonstrating that the
method is not only faster but also produces solutions of extremely high
quality.
