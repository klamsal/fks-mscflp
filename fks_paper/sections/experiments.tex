...
\paragraph{Instances.}
We use the large-scale MSCFLP benchmark families introduced by
...
We compare four variants, all implemented in Python~3.11 with Gurobi~13.0.2
...
Each run records the instance name, test bed, LP solver, stage widths,
LP time, restricted-MILP time, objective value, and optimality gap.
