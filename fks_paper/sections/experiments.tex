...
We report three variants, all implemented in Python~3.11 with Gurobi~13.0.2,
...
Results for p1000-4000 Test Bed~A (30 instances) are reported here; this family
was selected because its size and capacity regime produce clear quality
differences in Study~2.
[Results table to be inserted once KS-CG-WS runs are complete.]
...
Instead, we re-implement the G\&S algorithm exactly --- same formulation, same
